...
# function (results) {
#     colnames(results) <- c('chrom', "chrom_start",'gpos', "popA_1_freq", "ihhA",'popB_1_freq',"ihhB", "unstd_xpehh", "norm_xpehh", "significant","popA","popB")
#
#   tmp_ <- results[, .(popA, popB, chr, chrom_start, chrom_end = chrom_start + 1, nsize = 1, popA_1_freq, ihhA, popB_1_freq, ihhB, unstd_xpehh, norm_xpehh, significant_xpehh)]
#   tmp_ <- melt.data.table(tmp_, id.vars = c("popA", "popB", "chr", "chrom_start", "chrom_end", "nsize"))
#   
#   return (tmp_)
#   
#   }
